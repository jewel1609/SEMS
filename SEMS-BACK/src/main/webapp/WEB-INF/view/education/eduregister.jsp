 ...
 <div style="width:30%; height:100%; border:thin; border-style:double; border-radius: 5px; padding:5px;">
		<form:form commandName="educationVO" method="post"
	     ...
	     <form:errors path="educationLocation" /><br/>
	   	educationCurriculum : 
	   	<input type="text" name="educationCurriculum" value="${educationVO.educationCurriculum }">
	     ...
	     educationType : 
	   	<c:forEach items="${typeList}" var="type">
         	<input type="radio" class="educationType" name="educationType" value="${type.cdId}"/> ${type.cdNm}
      	   </c:forEach>
